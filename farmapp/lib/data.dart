...
List<AnimalInfo> animals = [
  ...
  AnimalInfo(2,
      name: 'Sheeps',
      iconImage: 'assets/images/sheep.png',
      description:
  ...
  AnimalInfo(3,
      name: 'Dogs',
      iconImage: 'assets/images/dog.png',
      description:
  ...
  AnimalInfo(4,
      name: 'Cats',
      iconImage: 'assets/images/cat.png',
      description:
  ...
  AnimalInfo(5,
      name: 'Goats',
      iconImage: 'assets/images/goat.png',
      description:
  ...
  AnimalInfo(6,
      name: 'Horses',
      iconImage: 'assets/images/horse.png',
      description:
